...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-16 h-18 border-b-[3px] border-gold bg-navy">
      ...
      <NavLink to="/" className="flex items-center gap-3 no-underline">
        ...
        <div>
          ...
          <div className="text-gold text-[10px] font-normal uppercase tracking-widest">
      ...
      <ul className="flex items-center gap-8 list-none m-0 p-0">
        ...
        <li>
          <a
            ...
            className="flex items-center gap-1.5 bg-gold text-navy font-semibold text-sm px-5 py-2.5 rounded no-underline hover:bg-gold-light transition-colors duration-200"
          >
            📲 Get a Quote
          </a>
        </li>
