...
│   │   │   ├── home/           # Hero, TrustBar, FeaturedProducts, WhyUs
│   │   │   ├── catalogue/      # ProductGrid, ProductCard
│   │   │   ├── about/          # AboutHero, StatsGrid, OpsPhotos
│   │   │   └── contact/        # ContactForm, ContactInfo, WhatsAppButton
...
│   ├── eexcel/                 # Django project settings
│   │   ├── settings/
...
│   │   ├── wsgi.py
│   │   └── asgi.py
│   ├── catalogue/              # Product catalogue app
│   │   ├── models.py           # Category, Product models
│   │   ├── serializers.py
│   │   ├── views.py
│   │   ├── urls.py
│   │   └── admin.py
│   ├── enquiries/              # Customer enquiry app
...
│   ├── project-scope.docx      # Digital Transformation Proposal
│   ├── meeting-agenda.docx     # Kickoff meeting agenda
│   └── content-checklist.docx # Client content checklist
│
├── assets/                     # Brand assets (not served by app)
│   ├── images/                 # Product photos
│   └── logo/                   # EESC logo files
│
├── .gitignore
